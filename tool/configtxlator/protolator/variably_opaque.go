...
func (soff variablyOpaqueFieldFactory) Handles(msg proto.Message, fieldName string, _ reflect.Type, _ reflect.Value) bool {
...
func (soff variablyOpaqueFieldFactory) NewProtoField(msg proto.Message, fieldName string, _ reflect.Type, fieldValue reflect.Value) (protoField, error) {
...
func (soff variablyOpaqueMapFieldFactory) Handles(msg proto.Message, fieldName string, _ reflect.Type, _ reflect.Value) bool {
...
func (soff variablyOpaqueSliceFieldFactory) Handles(msg proto.Message, fieldName string, _ reflect.Type, _ reflect.Value) bool {
