...
func (dff dynamicFieldFactory) Handles(msg proto.Message, fieldName string, _ reflect.Type, _ reflect.Value) bool {
...
func (dmff dynamicMapFieldFactory) Handles(msg proto.Message, fieldName string, _ reflect.Type, _ reflect.Value) bool {
...
func (dmff dynamicSliceFieldFactory) Handles(msg proto.Message, fieldName string, _ reflect.Type, _ reflect.Value) bool {
