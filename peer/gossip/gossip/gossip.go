...
type Gossip interface {
	...
	PeersOfChannel(common2.ChainID) []discovery2.NetworkMember
	...
	JoinChan(joinMsg api2.JoinChannelMessage, chainID common2.ChainID)
	...
	SuspectPeers(s api2.PeerSuspector)
