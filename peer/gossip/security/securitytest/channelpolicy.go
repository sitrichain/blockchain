...
func (c *ChannelPolicyManagerGetter) Manager(_ string) (policies.Manager, bool) {
...
func (m *ChannelPolicyManager) GetPolicy(_ string) (policies.Policy, bool) {
	return m.Policy, true
}

func (m *ChannelPolicyManager) Manager(_ []string) (policies.Manager, bool) {
