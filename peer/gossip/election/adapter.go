...
type peerImpl struct {
	member discovery2.NetworkMember
}
...
type gossip interface {
	...
	Peers() []discovery2.NetworkMember
...
func NewAdapter(gossip gossip, pkiid common2.PKIidType, channel common2.ChainID) LeaderElectionAdapter {
	return &adapterImpl{
		gossip:    gossip,
		selfPKIid: pkiid,
