...
type MessageCryptoService interface {
	...
	GetPKIidOfCert(peerIdentity PeerIdentityType) common2.PKIidType
	...
	// If the verification succeeded, Verify returns nil meaning no error occurred.
	// If peerIdentity is nil, then the verification fails.
	VerifyByChannel(chainID common2.ChainID, peerIdentity PeerIdentityType, signature, message []byte) error
