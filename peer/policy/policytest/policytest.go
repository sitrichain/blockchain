...
func (m *MockChannelPolicyManager) GetPolicy(_ string) (policies.Policy, bool) {
	return m.MockPolicy, true
}

func (m *MockChannelPolicyManager) Manager(_ []string) (policies.Manager, bool) {
...
func (m *MockMSPPrincipalGetter) Get(_ string) (*mspproto.MSPPrincipal, error) {
