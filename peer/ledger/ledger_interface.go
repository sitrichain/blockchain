...
type PeerLedger interface {
	...
	GetBlocksIterator(startBlockNumber uint64) (commonledger.ResultsIterator, error)
	...
	GetLedgerID() string
	// 取LedgerDB
	GetLedgerDB() statedb.VersionedDB
	...
	// 获取交易验证结果
	GetTxValidationResult(envBytes []byte, doMVCCValidation bool, updates *statedb.UpdateBatch) (*rwsetutil.TxRwSet, peer.TxValidationCode, error)
