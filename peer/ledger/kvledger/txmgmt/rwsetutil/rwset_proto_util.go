...
import (
	...
	"github.com/rongzer/blockchain/protos/ledger/rwset"
...
func (txRwSet *TxRwSet) ToProtoBytes() ([]byte, error) {
	...
	for _, nsRwSet := range txRwSet.NsRwSets {
		...
		protoRwSetBytes, err := nsRwSet.KvRwSet.Marshal()
		if err != nil {
			return nil, err
		}
	...
	protoTxRwSetBytes, err := protoTxRWSet.Marshal()
	if err != nil {
		return nil, err
	}
...
func (txRwSet *TxRwSet) FromProtoBytes(protoBytes []byte) error {
	protoTxRwSet := &rwset.TxReadWriteSet{}
	if err := protoTxRwSet.Unmarshal(protoBytes); err != nil {
		return err
	}
	...
	for _, protoNsRwSet := range protoNsRwSets {
		...
		if err := protoKvRwSet.Unmarshal(protoRwSetBytes); err != nil {
			return err
		}
