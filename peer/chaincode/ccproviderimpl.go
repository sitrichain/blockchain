...
func (c *ccProviderImpl) LockTxsim() {
	c.Lock()
}

func (c *ccProviderImpl) UnLockTxsim() {
	c.Unlock()
}

func (c *ccProviderImpl) GetTxsim() ledger.TxSimulator {
	return c.txsim
}

func (c *ccProviderImpl) TxsimDone(txsim ledger.TxSimulator) {
	txsim.Done()
}
