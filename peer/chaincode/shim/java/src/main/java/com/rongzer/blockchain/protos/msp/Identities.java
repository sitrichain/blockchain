...
package com.rongzer.blockchain.protos.msp;
...
public final class Identities {
  ...
  public  static final class SerializedIdentity extends
    ...
    protected FieldAccessorTable
      ...
      return Identities.internal_static_msp_SerializedIdentity_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SerializedIdentity.class, Builder.class);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      SerializedIdentity other = (SerializedIdentity) obj;
    ...
    public static SerializedIdentity parseFrom(
    ...
    public static SerializedIdentity parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SerializedIdentity parseFrom(
    ...
    public static SerializedIdentity parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SerializedIdentity parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SerializedIdentity parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SerializedIdentity prototype) {
    ...
    public static final class Builder extends
      ...
      // Construct using com.rongzer.blockchain.protos.msp.Identities.SerializedIdentity.newBuilder()
      private Builder() {
      ...
      public SerializedIdentity build() {
        SerializedIdentity result = buildPartial();
      ...
      public SerializedIdentity buildPartial() {
        SerializedIdentity result = new SerializedIdentity(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SerializedIdentity) {
          return mergeFrom((SerializedIdentity)other);
        } else {
      ...
      public Builder mergeFrom(SerializedIdentity other) {
        if (other == SerializedIdentity.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SerializedIdentity parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SerializedIdentity) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final SerializedIdentity DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SerializedIdentity();
    }
  ...
  static {
    String[] descriptorData = {
      ...
      "(\014BM\n!com.rongzer.blockchain.protos.mspZ" +
      "(github.com/rongzer/blockchain/protos/ms" +
      "pb\006proto3"
    };
