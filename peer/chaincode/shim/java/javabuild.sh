...
if [ x$ARCH == xx86_64 ]
then
    gradle -q -b ${PARENTDIR}/peer/chaincode/shim/java/build.gradle clean
    gradle -q -b ${PARENTDIR}/peer/chaincode/shim/java/build.gradle build
    cp -r ${PARENTDIR}/peer/chaincode/shim/java/build/libs /root/
else
    gradle -q -b ${PARENTDIR}/peer/chaincode/shim/java/build-arm.gradle clean
    gradle -q -b ${PARENTDIR}/peer/chaincode/shim/java/build-arm.gradle build
    cp -r ${PARENTDIR}/peer/chaincode/shim/java/build/libs /root/
fi
