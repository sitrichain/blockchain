...
import (
	...
	mockpolicies "github.com/rongzer/blockchain/common/testhelper"
	...
	syscc "github.com/rongzer/blockchain/peer/scc"
	"github.com/rongzer/blockchain/protos/common"
	pb "github.com/rongzer/blockchain/protos/peer"
	pbutils "github.com/rongzer/blockchain/protos/utils"
...
func initPeer(chainID string) (*testEnvironment, error) {
	...
	tempDir := newTempDir()
	viper.Set("peer.fileSystemPath", filepath.Join(tempDir, "rongzer", "production"))

	peerAddress, err := chain.GetLocalAddress()
	if err != nil {
	...
	chainmock.MockSetMSPIDGetter(mspGetter)
	...
	if err = chainmock.MockCreateChain(chainID); err != nil {
...
func TestDeploy(t *testing.T) {
	...
	spec := &pb.ChaincodeSpec{Type: 1, ChaincodeId: &pb.ChaincodeID{Name: "ex01", Path: "github.com/rongzer/blockchain/examples/chaincode/go/chaincode_example01", Version: "0"}, Input: &pb.ChaincodeInput{Args: [][]byte{[]byte("init"), []byte("a"), []byte("100"), []byte("b"), []byte("200")}}}
...
func TestRedeploy(t *testing.T) {
	...
	//invalid arguments
	spec := &pb.ChaincodeSpec{Type: 1, ChaincodeId: &pb.ChaincodeID{Name: "ex02", Path: "github.com/rongzer/blockchain/examples/chaincode/go/chaincode_example02", Version: "0"}, Input: &pb.ChaincodeInput{Args: [][]byte{[]byte("init"), []byte("a"), []byte("100"), []byte("b"), []byte("200")}}}
...
func TestDeployAndInvoke(t *testing.T) {
	...
	url := "github.com/rongzer/blockchain/examples/chaincode/go/chaincode_example01"
	...
	if err == nil {
		t.Fail()
		t.Logf("expecting blockchain to report error from chaincode failure")
		chaincode.GetChain().Stop(ctxt, cccid, &pb.ChaincodeDeploymentSpec{ChaincodeSpec: &pb.ChaincodeSpec{ChaincodeId: chaincodeID}})
		return
...
func TestDeployAndUpgrade(t *testing.T) {
	...
	url1 := "github.com/rongzer/blockchain/examples/chaincode/go/chaincode_example01"
	url2 := "github.com/rongzer/blockchain/examples/chaincode/go/chaincode_example02"
...
func TestWritersACLFail(t *testing.T) {
	...
	pm := chain.GetPolicyManager(chainID)
...
func TestMain(m *testing.M) {
	...
	err = testhelper.LoadMSPSetupForTesting()
	if err != nil {
...
func TestEndorserCreateChain(t *testing.T) {

	chainID := util.GetTestChainID()
	creator, err := signer.Serialize()
	assert.Error(t, err)

	rbcMessage := &common.RBCMessage{Type:0, Data: []byte(""), ChainID: chainID, TxID: "1", Creator: creator}

	resp, err := endorserServer.SendTransaction(context.Background(), rbcMessage)
	assert.Error(t, err)
	assert.NotNil(t, resp)

}

func TestEndorserGetBlock(t *testing.T) {

	chainID := util.GetTestChainID()
	creator, err := signer.Serialize()
	assert.Error(t, err)

	rbcMessage := &common.RBCMessage{Type:1, Data: []byte(""), ChainID: chainID, TxID: "1", Creator: creator, Extend: "0"}
...
func TestEndorserSendEndorsement(t *testing.T) {

	chainID := util.GetTestChainID()
	creator, err := signer.Serialize()
	assert.Error(t, err)

	rbcMessage := &common.RBCMessage{Type:3, Data: []byte(""), ChainID: chainID, TxID: "1", Creator: creator, Extend: "0"}
...
func TestEndorserReceiveEndorsement(t *testing.T) {

	chainID := util.GetTestChainID()
	creator, err := signer.Serialize()
	assert.Error(t, err)

	rbcMessage := &common.RBCMessage{Type:4, Data: []byte(""), ChainID: chainID, TxID: "1", Creator: creator, Extend: "0"}
...
func TestEndorserEndorseResponse(t *testing.T) {

	chainID := util.GetTestChainID()
	creator, err := signer.Serialize()
	assert.Error(t, err)

	rbcMessage := &common.RBCMessage{Type:7, Data: []byte(""), ChainID: chainID, TxID: "1", Creator: creator, Extend: "0"}
...
func TestEndorserSendHttpRequest(t *testing.T) {

	chainID := util.GetTestChainID()
	creator, err := signer.Serialize()
	assert.Error(t, err)

	rbcMessage := &common.RBCMessage{Type:21, Data: []byte(""), ChainID: chainID, TxID: "1", Creator: creator, Extend: "0"}
...
func TestEndorserGetUnendorsedCount(t *testing.T) {

	chainID := util.GetTestChainID()
	creator, err := signer.Serialize()
	assert.Error(t, err)

	rbcMessage := &common.RBCMessage{Type:23, Data: []byte(""), ChainID: chainID, TxID: "1", Creator: creator, Extend: "0"}
...
func TestEndorserHandleDeliverMessage(t *testing.T) {

	chainID := util.GetTestChainID()
	creator, err := signer.Serialize()
	assert.Error(t, err)

	rbcMessage := &common.RBCMessage{Type:25, Data: []byte(""), ChainID: chainID, TxID: "1", Creator: creator, Extend: "0"}
