...
import (
	...
	configtxtest "github.com/rongzer/blockchain/common/testhelper"
	...
	peergossip "github.com/rongzer/blockchain/peer/gossip/security"
	"github.com/rongzer/blockchain/peer/gossip/security/securitytest"
...
// to channel peers.
func (ds *mockDeliveryClient) StartDeliverForChannel(chainID string, ledgerInfo blocksprovider.LedgerInfo, finalizer func()) error {
	return nil
}
...
func TestConfigerInvokeJoinChainMissingParams(t *testing.T) {
	viper.Set("peer.fileSystemPath", "/tmp/rongzertest/")
	os.Mkdir("/tmp/rongzertest", 0755)
	defer os.RemoveAll("/tmp/rongzertest/")
