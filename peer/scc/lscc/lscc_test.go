...
import (
	...
	"github.com/rongzer/blockchain/common/testhelper/scc"
	"github.com/rongzer/blockchain/common/util"
	mockchain "github.com/rongzer/blockchain/peer/chain/mock"
	"github.com/rongzer/blockchain/peer/chaincode/shim"
	"github.com/rongzer/blockchain/peer/common/ccpackage"
...
func TestInstall(t *testing.T) {
	path := "github.com/rongzer/blockchain/examples/chaincode/go/chaincode_example02"
...
func TestReinstall(t *testing.T) {
	...
	cds, err := constructDeploymentSpec("example02", "github.com/rongzer/blockchain/examples/chaincode/go/chaincode_example02", "0", [][]byte{[]byte("init"), []byte("a"), []byte("100"), []byte("b"), []byte("200")}, true)
	if err != nil {
		t.FailNow()
	}
...
func TestMultipleDeploy(t *testing.T) {
	...
	//deploy 01
	cds, err = constructDeploymentSpec("example01", "github.com/rongzer/blockchain/examples/chaincode/go/chaincode_example01", "0", [][]byte{[]byte("init"), []byte("a"), []byte("100"), []byte("b"), []byte("200")}, true)
	if err != nil {
		t.FailNow()
	}
...
func TestTamperChaincode(t *testing.T) {
	...
	//deploy 01
	cds, err := constructDeploymentSpec("example01", "github.com/rongzer/blockchain/examples/chaincode/go/chaincode_example01", "0", [][]byte{[]byte("init"), []byte("a"), []byte("1"), []byte("b"), []byte("2")}, true)
	if err != nil {
...
func testIPolDeploy(t *testing.T, iPol string, successExpected bool) {
	...
	cds, err := constructDeploymentSpec("example02", "github.com/rongzer/blockchain/examples/chaincode/go/chaincode_example02", "0", [][]byte{[]byte("init"), []byte("a"), []byte("100"), []byte("b"), []byte("200")}, false)
	assert.NoError(t, err)
...
func testIPolUpgrade(t *testing.T, iPol string, successExpected bool) {
	...
	cds, err = constructDeploymentSpec("example02", "github.com/rongzer/blockchain/examples/chaincode/go/chaincode_example02", "1", [][]byte{[]byte("init"), []byte("a"), []byte("100"), []byte("b"), []byte("200")}, false)
	assert.NoError(t, err)
	cdsbytes, err = proto.Marshal(cds)
	assert.NoError(t, err)
...
func TestMain(m *testing.M) {
	...
	mockchain.MockSetMSPIDGetter(mspGetter)
