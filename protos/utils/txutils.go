...
func GetPayloads(txActions *peer.TransactionAction) (*peer.ChaincodeActionPayload, *peer.ChaincodeAction, error) {
	...
	err := ccPayload.Unmarshal(txActions.Payload)
	if err != nil {
		return nil, nil, err
	}
	...
	err = pRespPayload.Unmarshal(ccPayload.Action.ProposalResponsePayload)
	if err != nil {
		return nil, nil, err
	}
	...
	err = respPayload.Unmarshal(pRespPayload.Extension)
	if err != nil {
...
func GetBytesProposalPayloadForTx(payload *peer.ChaincodeProposalPayload, _ []byte) ([]byte, error) {
	...
	// the blockchain may be extended to encode more elaborate visibility
...
func MockSignedEndorserProposal2OrPanic(chainID string, _ *peer.ChaincodeSpec, signer msp.SigningIdentity) (*peer.SignedProposal, *peer.Proposal) {
