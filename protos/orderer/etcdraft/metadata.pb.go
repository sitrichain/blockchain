...
type BlockMetadata struct {
	...
	// and their Raft IDs.
	ConsenterEndpoints []string `protobuf:"bytes,1,rep,name=consenter_endpoints,json=consenterEndpoints,proto3" json:"consenter_endpoints,omitempty"`
	...
	PeerEndpoints        []string `protobuf:"bytes,4,rep,name=peer_endpoints,json=peerEndpoints,proto3" json:"peer_endpoints,omitempty"`
...
func (m *BlockMetadata) GetConsenterEndpoints() []string {
	if m != nil {
		return m.ConsenterEndpoints
	}
	return nil
}
