...
type ConsensusRequest struct {
	...
	SourceNodeInfo       *NodeInfo `protobuf:"bytes,4,opt,name=sourcenodeinfo,proto3" json:"sourcenodeinfo,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
type SubmitRequest struct {
	...
	SourceNodeInfo       *NodeInfo        `protobuf:"bytes,3,opt,name=sourcenodeinfo,proto3" json:"sourcenodeinfo,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
