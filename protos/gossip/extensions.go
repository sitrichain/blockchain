...
func (m *GossipMessage) IsRemoteStateMessage() bool {
	return m.GetStateRequest() != nil || m.GetStateResponse() != nil || m.GetLightweightRequest() != nil
}
...
func (m *SignedGossipMessage) Sign(signer Signer) (*Envelope, error) {
	...
	m.Envelope = nil
	payload, err := m.GossipMessage.Marshal()
	if err != nil {
		return nil, err
	}
...
func (e *Envelope) ToGossipMessage() (*SignedGossipMessage, error) {
	msg := &GossipMessage{}
	if err := msg.Unmarshal(e.Payload); err != nil {
...
func (s *SecretEnvelope) InternalEndpoint() string {
	secret := &Secret{}
	if err := secret.Unmarshal(s.Payload); err != nil {
		return ""
	}
