...
// NewChainConfigManager creates a new ChannelConfig
...
func (cc *ChannelConfig) Validate(_ interface{}, groups map[string]ValueProposer) error {
...
func (cc *ChannelConfig) validateHashingAlgorithm() error {
	...
	case bccsp.SHA256:
		cc.hashingAlgorithm = util.WriteAndSumSha256
	case bccsp.SHA3_256:
