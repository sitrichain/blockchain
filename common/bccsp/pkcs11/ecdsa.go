...
func (csp *impl) signECDSA(k ecdsaPrivateKey, digest []byte, _ bccsp.SignerOpts) (signature []byte, err error) {
...
func (csp *impl) verifyECDSA(k ecdsaPublicKey, signature, digest []byte, _ bccsp.SignerOpts) (valid bool, err error) {
