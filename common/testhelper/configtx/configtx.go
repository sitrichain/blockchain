...
func (t *Transactional) PreCommit(_ interface{}) error { return nil }

// CommitConfig does nothing
func (t *Transactional) CommitProposals(_ interface{}) {}

// RollbackConfig does nothing
func (t *Transactional) RollbackProposals(_ interface{}) {}
...
func (pp *PolicyProposer) ProposePolicy(_ interface{}, key string, configPolicy *cb.ConfigPolicy) (proto.Message, error) {
	pp.LastKey = key
...
func (pp *PolicyProposer) BeginPolicyProposals(_ interface{}, groups []string) ([]policies.Proposer, error) {
...
func (vp *ValueProposer) BeginValueProposals(_ interface{}, groups []string) (config.ValueDeserializer, []config.ValueProposer, error) {
...
func (vp *ValueProposer) Deserialize(_ string, _ []byte) (proto.Message, error) {
...
// ProposeConfigUpdate
func (cm *Manager) ProposeConfigUpdate(_ *cb.Envelope) (*cb.ConfigEnvelope, error) {
...
func (cm *Manager) Validate(_ *cb.ConfigEnvelope) error {
