...
func (m *MockQueryExecutor) GetStateMultipleKeys(_ string, _ []string) ([][]byte, error) {
	return nil, nil

}

func (m *MockQueryExecutor) GetStateRangeScanIterator(_ string, _ string, _ string) (ledger.ResultsIterator, error) {
	return nil, nil

}

func (m *MockQueryExecutor) ExecuteQuery(_, _ string) (ledger.ResultsIterator, error) {
	return nil, nil
}
