...
// Membership service provider APIs for Rongzer Blockchain:
//
...
// them to participate in Rongzer/blockchain network. Clients use these
...
type Identity interface {
	...
	// E.g., if it is a blockchain TCert implemented as identity, validate
...
// to sign transactions, or blockchain endorser who wishes to sign proposal
// processing outcomes.
...
const (
	BLOCKCHAIN ProviderType = 0 // MSP is of BLOCKCHAIN type
)
