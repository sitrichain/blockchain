...
func (p *policyProposerRoot) BeginPolicyProposals(_ interface{}, groups []string) ([]policies.Proposer, error) {
	if len(groups) != 1 {
		log.Logger.Panicf("Initializer only supports having one root group")
	}
	return []policies.Proposer{p.policyManager}, nil
}

func (i *policyProposerRoot) ProposePolicy(_ interface{}, _ string, _ *cb.ConfigPolicy) (proto.Message, error) {
	return nil, fmt.Errorf("Programming error, this should never be invoked")
}

// PreCommit is a no-op and returns nil
func (i *policyProposerRoot) PreCommit(_ interface{}) error {
	return nil
}

// RollbackConfig is used to abandon a new config proposal
func (i *policyProposerRoot) RollbackProposals(_ interface{}) {}

// CommitConfig is used to commit a new config proposal
func (i *policyProposerRoot) CommitProposals(_ interface{}) {}
...
func NewInitializer() configtxapi.Initializer {
