...
func NewConfigResult(config *cb.ConfigGroup, proposer configtxapi.Proposer) (ConfigResult, error) {
...
func processConfig(channelGroup *cb.ConfigGroup, proposer configtxapi.Proposer) (*configResult, error) {
...
func (cm *configManager) processConfig(channelGroup *cb.ConfigGroup) (*configResult, error) {
	log.Logger.Debugf("Beginning new config for channel %s", cm.current.channelID)
